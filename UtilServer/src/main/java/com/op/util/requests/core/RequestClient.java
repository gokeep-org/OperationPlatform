...
public abstract class RequestClient<T> {
    ...
    protected com.op.util.requests.bean.HttpResponse execute(String url) {
        return execute(url, null, null, null, null);
    }

    protected com.op.util.requests.bean.HttpResponse execute(String url, Map<String, String> headers) {
        return execute(url, null, null, null, headers);
    }

    protected com.op.util.requests.bean.HttpResponse execute(String url, Map<String, String> params, Map<String, String> headers) {
        return execute(url, params, null, null, headers);
    }

    protected com.op.util.requests.bean.HttpResponse execute(String url, Map<String, String> params, Object body, Map<String, String> headers) {
