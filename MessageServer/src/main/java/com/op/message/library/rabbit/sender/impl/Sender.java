...
//public class Sender implements com.op.message.library.rabbit.sender.Sender, RabbitTemplate.ConfirmCallback {
//    private static final Logger LOGGER = LoggerFactory.getLogger(com.op.message.library.rabbit.sender.Sender.class);
//
