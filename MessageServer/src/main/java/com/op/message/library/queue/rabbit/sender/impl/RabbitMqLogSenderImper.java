...
import com.op.message.library.queue.kafka.send.KafkaLogSenderImpl;
...
public class RabbitMqLogSenderImper extends BaseService implements Sender, RabbitTemplate.ConfirmCallback {
